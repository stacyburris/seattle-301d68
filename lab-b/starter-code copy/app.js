...
// When joe.scope() is invoked it outputs the correct function so "this" is the typeof Student which is a constructor function. Scope is the method. this equals to the global object...
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked its a globalThis and in a window property so it doesn't know its a function any more.
// 3. Explain why "this" is different when an arrow function is used.
// "this" is different than the arrow functions because the function is telling this that is is student where as the arrow function becomes a globalThis and doesn't know its a function.
